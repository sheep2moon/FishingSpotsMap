...
const DetailsSpotForm = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & DetailsSpotFormProps
>(
  (
    {
      tent,
...
DetailsSpotForm.displayName = "DetailsSpotForm";

export { DetailsSpotForm };

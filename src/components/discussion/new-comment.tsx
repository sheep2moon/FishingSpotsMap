...
const NewComment = (props: NewCommentProps) => {
  ...
  return (
    <div
      ref={newCommentRef}
      className={cn(
        "fixed bottom-0 z-10 flex w-full max-w-screen-xl gap-2 rounded-t-md border-t border-primary/20 bg-primary px-2 py-2 transition-all dark:bg-secondary-950"
      )}
    >

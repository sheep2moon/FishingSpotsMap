...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-[9999] bg-white/80 backdrop-blur-sm dark:bg-primary-950/80",
      className
    )}
    {...props}
  />
...
>(({ className, closeButton = true, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-[99999] flex w-full max-w-lg translate-x-[-50%] translate-y-[-50%] flex-col gap-4 border border-primary-200 bg-white p-6 shadow-lg duration-200 dark:border-primary-800 dark:bg-primary-950 sm:rounded-lg md:w-full",
        className
      )}
      {...props}
    >

  ...
  "relative w-full rounded-lg border border-primary-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-primary-950 dark:border-primary-800 dark:[&>svg]:text-primary-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-red-400/50 text-red-400 dark:border-red-400 [&>svg]:text-red-500 dark:border-red-700/50 dark:text-red-700 dark:border-red-700 dark:[&>svg]:text-red-900",
      },
    },
    defaultVariants: {
      variant: "default",
